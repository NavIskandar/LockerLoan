...
if (isset($_SESSION['door_memberID']) AND !empty($_SESSION['door_memberID'])) {
    define('DIRECT_INCLUDE', true);
    include MDLBS.'locker_loan/door_circulation_action.php';
} else {
?>
  ...
  <div class="menuBoxInner circulationIcon">
    ...
    <div class="sub_section">
	    <div class="action_button">
		    <?php echo __('Sirkulasi - Peminjaman pintu loker dengan menulis id anggota menggunakan keybord atau pemindai barcode'); ?>
	    </div>
      <form id="startCirc" action="<?php echo MWB; ?>locker_loan/door_circulation_action.php" method="post" style="display: inline;">
      <?php echo __('Member ID'); ?> :
      <?php
      // create AJAX drop down
      $ajaxDD = new simbio_fe_AJAX_select();
      $ajaxDD->element_name = 'door_memberID';
      $ajaxDD->element_css_class = 'ajaxInputField';
      $ajaxDD->handler_URL = MWB.'locker_loan/member_AJAX_response.php';
      echo $ajaxDD->out();
      ?>
