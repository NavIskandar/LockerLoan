...
class longBiblioAtt
{
	...
	{
		$pattern_q = $dbs->query('SELECT pattern_prefix, pattern_zero, pattern_suffix FROM locker_pattern WHERE pattern_prefix REGEXP "'.$p_prefix.'"');
	...
	public static function getLastID()
	{
		global $dbs;
		// set query
		$sql_d = $dbs->query("SELECT pattern_id FROM locker_pattern");
		// Get Last ID
	...
	public function getLastNumber($dbs, $p_prefix)
	{
		...
		// Set query 
		$sql_q = $dbs->query('SELECT door_code FROM door WHERE door_code REGEXP "'.$lastNumber['prefix'].'"');
