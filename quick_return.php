...
<div class="menuBoxInner quickReturnIcon">
    ...
    <div class="sub_section">
	    <div class="action_button">
		    <?php echo __('Masukan kode pintu untuk mengembalikan dengan menggunakan keyboard atau pemindai barcode'); ?>
	    </div>
      <form class="notAJAX" action="<?php echo MWB; ?>locker_loan/ajax_action.php" target="circAction" method="post" style="display: inline;">
      <?php echo __('Kode Pintu'); ?> :
